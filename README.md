...
봉사자들은 현장에서 찍은 사진을 카카오톡 단체 채팅방으로 공유하고 있었는데, 두 가지 문제가 있었습니다.

**사진 정리가 안 된다** — 봉사자마다 공유 방식이 달라서 이름과 함께 올리는 사람도 있고, 사진만 올리는 사람도 있었습니다. 어떤 사진이 어떤 아이의 것인지 파악이 안 되니 아이별 아카이브가 전혀 쌓이지 않았습니다.

**사진이 사라진다** — 카카오톡은 일정 기간이 지나면 사진을 내려받을 수 없어, 소중한 사진들이 그냥 소실되고 있었습니다. 구글 드라이브에 따로 옮겨 보관하려 해도 파일이 많은 드라이브에서 모바일로 아이별 분류 작업을 하는 건 너무 번거로웠습니다.

댕카이브는 이 두 문제를 한 번에 해결합니다. 사진을 올리면서 바로 아이 이름을 지정하고, 이름이 지정된 사진은 구글 드라이브 아이별 폴더로 자동 전송됩니다.
